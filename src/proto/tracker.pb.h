...
#define protocol_Report_init_default             {"", {0, {0}}, 0, false, 0, 0, {protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default, protocol_TrackerPosition_init_default}}
#define protocol_TrackerPosition_init_default    {0, 0, 0, 0}
#define protocol_Report_init_zero                {"", {0, {0}}, 0, false, 0, 0, {protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero, protocol_TrackerPosition_init_zero}}
...
#define protocol_TrackerPosition_longitude_tag   7
#define protocol_TrackerPosition_speed_tag       10
#define protocol_Report_token_tag                1
#define protocol_Report_sessionId_tag            4
#define protocol_Report_vehicleId_tag            7
#define protocol_Report_timestamp_tag            10
#define protocol_Report_positions_tag            13

/* Struct field encoding specification for nanopb */
#define protocol_Report_FIELDLIST(X, a) \
X(a, STATIC,   REQUIRED, STRING,   token,             1) \
X(a, STATIC,   REQUIRED, BYTES,    sessionId,         4) \
X(a, STATIC,   REQUIRED, INT64,    vehicleId,         7) \
X(a, STATIC,   OPTIONAL, INT64,    timestamp,        10) \
X(a, STATIC,   REPEATED, MESSAGE,  positions,        13)
...
X(a, STATIC,   REQUIRED, DOUBLE,   longitude,         7) \
X(a, STATIC,   REQUIRED, DOUBLE,   speed,            10)
...
#define protocol_Report_size                     1098
